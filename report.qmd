...
concen2 |>
  ggplot(aes(x = log(firms_2007), y = avg_concentration)) +
  geom_point() +
  geom_smooth()
...
concen2 |>
  ggplot(aes(x = log(pop2011), y = avg_concentration)) +
  geom_point() +
  geom_smooth()
