...
Below is the analysis we used to support our hypothesis about the region we believe suffers from the most air pollution. We calculated two statistics---the first being the number of metropolitan areas per region in 2013 (county with a population over 50,000), and the second being the proportion of metropolitan areas to the number of counties. We found that the Southeast had the most metropolitan areas at 492, however, interestingly, the Northeast had the highest proportion of counties identified as metropolitan at \~60%.
...
Additionally, to support our hypothesis, we found the number of firms per region in 2007 and found that the Southeast had the most firms at 7,771,015, followed by the West, the Midwest, the Northeast, and the Southeast.
