...
-   Write a brief description of the observations.
    ...
    -   The data set provides information about the amount of air pollution in areas in states and certain counties across the United States. Each observation was one specific recording of air pollution at a certain monitoring station known by its state and county.
...
-   A description of the research topic along with a concise statement of your hypotheses on this topic.
    ...
    The research topic is to explore air pollution levels across the United States based on Air Quality Systems which are located across the United States. We hypothesize that there will be a substantial difference in air pollution across the regions in the United States. We hypothesize highest levels of air pollution will be in the Southwest due to a large presence of oil drilling and the lowest levels of air pollution will be in the Northeast or West due to their locations near the coast which allows for ocean air to reduce air pollution.

-   Identify the types of variables in your research question. Categorical? Quantitative?

    The variables "MeasureName," "MeasureType," "StratificationLevel," "StateName," "CountyName," "Unit," "UnitName," "DataOrigin," and "Monitor Only" are categorical. The variables "MeasureId," "StateFips," "CountyFips," "ReportYear"and "Value" are quantitative.
...
-   In 1-2 sentences, explain how your research question builds on / is different than the article you have cited.
    ...
    -   This study focused on building an air pollution index across metropolitan areas in the US, which we can contrast with our findings in metropolitan areas as well as some rural regions in the United States. In addition, we can analyze air pollution data and how that differs between regions in the United States. Our research question goes beyond focusing on a city level view of air pollution mainly focused upon and how to create a uniform air pollution index in this article.
